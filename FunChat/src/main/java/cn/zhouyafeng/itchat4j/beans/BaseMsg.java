...
public class BaseMsg implements Serializable {
	...
	private String msgFromUserNameInGroup;

	public String getMsgFromUserNameInGroup() {
		return msgFromUserNameInGroup;
	}

	public void setMsgFromUserNameInGroup(String msgFromUserNameInGroup) {
		this.msgFromUserNameInGroup = msgFromUserNameInGroup;
	}
